...
namespace DOI.Tests.TestHelpers
{
    public class OfflineRunTestsHelper
    {
        ...
        public int BusinessHoursErrorCount(string schemaName, string tableName, string beforeOrWithinLoop)
        {
            sqlHelper = new TestHelper.SqlHelper();
            ...
            int businessHoursErrorCount =
                ...
                WHERE SchemaName = '{schemaName}' 
                    AND TableName = '{tableName}' 
                    AND ErrorText = 'Stopping Offline DDI, within loop.  Business hours are here.'");
        ...
        public static readonly string SeqNoForIndexOperationSql = @"
            ...
            WHERE SchemaName = 'dbo' 
                ...
                AND IsLogStartOperation = 0
                AND IsLogFinishOperation = 0
                AND IsBusinessHoursCheckOperation = 0";
