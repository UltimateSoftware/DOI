...
namespace Reporting.Ingestion.Integration.Tests.Database.DataDrivenIndexEngine
{
    ...
    public class ErrorHandlingTests : SqlIndexJobBaseTest
    {
        ...
        public virtual void TearDown()
        {
            ...
            sqlHelper.Execute("ALTER RESOURCE GOVERNOR RECONFIGURE");
        }
        ...
        public void SpaceFailuresTests(string fileType)
        {
            ...
            var dbMetadataReader = sqlHelper.ExecuteReader($@"SELECT * FROM Utility.vwFreeSpaceOnDisk WHERE DBName = '{dbName}' AND FileType = '{vwFreeSpaceOnDiskFileType}'");

            var driveLetterWhereIndexesAreStored = "";
            ...
            this.dataDrivenIndexTestHelper.ExecuteSPRefreshIndexStructuresQueue(true);
            this.dataDrivenIndexTestHelper.ExecuteSPRefreshIndexStructuresRun(true);
        ...
        public void ResourceGovernorNotTurnedOnTest()
        {
            ...
            try
            {
                dataDrivenIndexTestHelper.ExecuteSPRefreshIndexStructuresRun(true);
            }
            catch (Exception e)
            {
