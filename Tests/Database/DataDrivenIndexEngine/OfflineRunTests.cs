...
namespace Reporting.Ingestion.Integration.Tests.Database.DataDrivenIndexEngine
{
    ...
    END;");
        ...
        public virtual void HappyPath()
        {
            ...
            dataDrivenIndexTestHelper.ExecuteSPRefreshIndexStructuresQueue(false, false);
            ...
            this.dataDrivenIndexTestHelper.ExecuteSPRefreshIndexStructuresRun(false, SchemaName, TempTableName);
        ...
        public void RunIntoBusinessHoursLogsError_StopBeforeQueue()
        {
            ...
            // populate queue
            this.dataDrivenIndexTestHelper.ExecuteSPRefreshIndexStructuresQueue(false, false);
        ...
        public virtual void StoppedRun()
        {
            ...
            //run queue
            Task result = this.dataDrivenIndexTestHelper.ExecuteSPRefreshIndexStructuresRunAsync(false, SchemaName, TempTableName);
