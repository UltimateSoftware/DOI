...
using TestHelper = DOI.Tests.TestHelpers.Metadata.vwPartitioning_PrepTablesConstraintsHelper;
...
{
    public class ViewTests_vwPartitioning_Tables_PrepTables_Constraints : DOIBaseTest
    {
        ...
        [Test]
        public void Views_vwPartitioning_Tables_PrepTables_Constraints_MetadataIsAccurate(string boundaryInterval, string initialDate, int numOfFutureIntervals, bool usesSlidingWindow = false, int? slidingWindowSize = null)
        {
