...
using TestHelper = DOI.Tests.TestHelpers.Metadata.SysStatsColumnsHelper;
...
namespace DOI.Tests.IntegrationTests.MetadataTests.SystemMetadata
{
    ...
    public class RefreshMetadataTests_SysStatsColumns : DOIBaseTest
    {
        [SetUp]
        public void Setup()
        {
        ...
        [Test]
        public void RefreshMetadata_SysStatsColumns_MetadataIsAccurate()
        {
            //run refresh metadata
            sqlHelper.Execute(TestHelper.RefreshMetadata_SysStatsColumnsSql);
