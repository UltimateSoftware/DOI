...
using TestHelper = DOI.Tests.TestHelpers.Metadata.SysColumnsHelper;
...
namespace DOI.Tests.IntegrationTests.MetadataTests.SystemMetadata
{
    ...
    public class RefreshMetadataTests_SysColumns : DOIBaseTest
    {
        [SetUp]
        public void Setup()
        {
        ...
        [Test]
        public void RefreshMetadata_SysColumns_MetadataIsAccurate()
        {
            //run refresh metadata
            sqlHelper.Execute(TestHelper.RefreshMetadata_SysColumnsSql);
