...
namespace DDI.TestHelpers
{
    ...
    public class SqlHelper
    {
        ...
        public int Execute(string sql, int commandTimeOut = 30, bool marsEnabled = true)
        {
            ...
            try
            {
                var connectionString = marsEnabled
                    ? ConnectionString
                    : ConnectionString.Replace(";MultipleActiveResultSets=True", "");
                connection = new SqlConnection(connectionString);
        ...
        public string ConnectionString
        {
            get
            {
                ...
                connectionString = TestConfigurationHelper.GetReportingConnectionString();
                return connectionString;
            }
        }
