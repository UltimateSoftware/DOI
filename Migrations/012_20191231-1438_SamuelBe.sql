...
GO
CREATE TABLE [DDI].[RG_Recovery_1_IndexesColumnStore]
(
[DatabaseName] [nvarchar] (128) NOT NULL,
[SchemaName] [nvarchar] (128) NOT NULL,
[TableName] [nvarchar] (128) NOT NULL,
[IndexName] [nvarchar] (128) NOT NULL,
[IsIndexMissingFromSQLServer] [bit] NOT NULL CONSTRAINT [RG_Recovery_2_IndexesColumnStore] DEFAULT ((0)),
...
[OptionDataCompression_Desired] [varchar] (30) NOT NULL CONSTRAINT [RG_Recovery_3_IndexesColumnStore] DEFAULT ('COLUMNSTORE'),
...
[AllColsInTableSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_4_IndexesColumnStore] DEFAULT ((0)),
[NumFixedCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_5_IndexesColumnStore] DEFAULT ((0)),
[NumVarCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_6_IndexesColumnStore] DEFAULT ((0)),
[NumCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_7_IndexesColumnStore] DEFAULT ((0)),
[FixedColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_8_IndexesColumnStore] DEFAULT ((0)),
[VarColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_9_IndexesColumnStore] DEFAULT ((0)),
[ColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_10_IndexesColumnStore] DEFAULT ((0)),
[NumRows_Actual] [bigint] NOT NULL CONSTRAINT [RG_Recovery_11_IndexesColumnStore] DEFAULT ((0)),
[IndexSizeMB_Actual] [decimal] (10, 2) NOT NULL CONSTRAINT [RG_Recovery_12_IndexesColumnStore] DEFAULT ((0)),
[DriveLetter] [char] (1) NULL,
[IsIndexLarge] [bit] NOT NULL CONSTRAINT [RG_Recovery_13_IndexesColumnStore] DEFAULT ((0)),
[IndexMeetsMinimumSize] [bit] NOT NULL CONSTRAINT [RG_Recovery_14_IndexesColumnStore] DEFAULT ((0)),
[Fragmentation] [float] NOT NULL CONSTRAINT [RG_Recovery_15_IndexesColumnStore] DEFAULT ((0)),
[FragmentationType] [varchar] (5) NOT NULL CONSTRAINT [RG_Recovery_16_IndexesColumnStore] DEFAULT ('None'),
[AreDropRecreateOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_17_IndexesColumnStore] DEFAULT ((0)),
[AreRebuildOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_18_IndexesColumnStore] DEFAULT ((0)),
[AreRebuildOnlyOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_19_IndexesColumnStore] DEFAULT ((0)),
[AreReorgOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_20_IndexesColumnStore] DEFAULT ((0)),
[AreSetOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_21_IndexesColumnStore] DEFAULT ((0)),
[IsColumnListChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_22_IndexesColumnStore] DEFAULT ((0)),
[IsFilterChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_23_IndexesColumnStore] DEFAULT ((0)),
[IsClusteredChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_24_IndexesColumnStore] DEFAULT ((0)),
[IsPartitioningChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_25_IndexesColumnStore] DEFAULT ((0)),
[IsDataCompressionChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_26_IndexesColumnStore] DEFAULT ((0)),
[IsDataCompressionDelayChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_27_IndexesColumnStore] DEFAULT ((0)),
[IsStorageChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_28_IndexesColumnStore] DEFAULT ((0)),
[NumPages_Actual] [int] NULL CONSTRAINT [RG_Recovery_29_IndexesColumnStore] DEFAULT ((0)),
[TotalPartitionsInIndex] [int] NOT NULL CONSTRAINT [RG_Recovery_30_IndexesColumnStore] DEFAULT ((0)),
[NeedsPartitionLevelOperations] [bit] NOT NULL CONSTRAINT [RG_Recovery_31_IndexesColumnStore] DEFAULT ((0))
)
GO
INSERT INTO [DDI].[RG_Recovery_1_IndexesColumnStore]([DatabaseName], [SchemaName], [TableName], [IndexName], [IsIndexMissingFromSQLServer], [IsClustered_Desired], [IsClustered_Actual], [ColumnList_Desired], [ColumnList_Actual], [IsFiltered_Desired], [IsFiltered_Actual], [FilterPredicate_Desired], [FilterPredicate_Actual], [OptionDataCompression_Desired], [OptionDataCompression_Actual], [OptionDataCompressionDelay_Desired], [OptionDataCompressionDelay_Actual], [Storage_Desired], [Storage_Actual], [StorageType_Desired], [StorageType_Actual], [PartitionFunction_Desired], [PartitionFunction_Actual], [PartitionColumn_Desired], [PartitionColumn_Actual], [AllColsInTableSize_Estimated], [NumFixedCols_Estimated], [NumVarCols_Estimated], [NumCols_Estimated], [FixedColsSize_Estimated], [VarColsSize_Estimated], [ColsSize_Estimated], [NumRows_Actual], [IndexSizeMB_Actual], [DriveLetter], [IsIndexLarge], [IndexMeetsMinimumSize], [Fragmentation], [FragmentationType], [AreDropRecreateOptionsChanging], [AreRebuildOptionsChanging], [AreRebuildOnlyOptionsChanging], [AreReorgOptionsChanging], [AreSetOptionsChanging], [IsColumnListChanging], [IsFilterChanging], [IsClusteredChanging], [IsPartitioningChanging], [IsDataCompressionChanging], [IsDataCompressionDelayChanging], [IsStorageChanging], [NumPages_Actual], [TotalPartitionsInIndex], [NeedsPartitionLevelOperations]) SELECT [DatabaseName], [SchemaName], [TableName], [IndexName], [IsIndexMissingFromSQLServer], [IsClustered_Desired], [IsClustered_Actual], [ColumnList_Desired], [ColumnList_Actual], [IsFiltered_Desired], [IsFiltered_Actual], [FilterPredicate_Desired], [FilterPredicate_Actual], [OptionDataCompression_Desired], [OptionDataCompression_Actual], [OptionDataCompressionDelay_Desired], [OptionDataCompressionDelay_Actual], [Storage_Desired], [Storage_Actual], [StorageType_Desired], [StorageType_Actual], [PartitionFunction_Desired], [PartitionFunction_Actual], [PartitionColumn_Desired], [PartitionColumn_Actual], [AllColsInTableSize_Estimated], [NumFixedCols_Estimated], [NumVarCols_Estimated], [NumCols_Estimated], [FixedColsSize_Estimated], [VarColsSize_Estimated], [ColsSize_Estimated], [NumRows_Actual], [IndexSizeMB_Actual], [DriveLetter], [IsIndexLarge], [IndexMeetsMinimumSize], [Fragmentation], [FragmentationType], [AreDropRecreateOptionsChanging], [AreRebuildOptionsChanging], [AreRebuildOnlyOptionsChanging], [AreReorgOptionsChanging], [AreSetOptionsChanging], [IsColumnListChanging], [IsFilterChanging], [IsClusteredChanging], [IsPartitioningChanging], [IsDataCompressionChanging], [IsDataCompressionDelayChanging], [IsStorageChanging], [NumPages_Actual], [TotalPartitionsInIndex], [NeedsPartitionLevelOperations] FROM [DDI].[IndexesColumnStore]
GO
...
GO
INSERT INTO [DDI].[IndexesColumnStore]([DatabaseName], [SchemaName], [TableName], [IndexName], [IsIndexMissingFromSQLServer], [IsClustered_Desired], [IsClustered_Actual], [ColumnList_Desired], [ColumnList_Actual], [IsFiltered_Desired], [IsFiltered_Actual], [FilterPredicate_Desired], [FilterPredicate_Actual], [OptionDataCompression_Desired], [OptionDataCompression_Actual], [OptionDataCompressionDelay_Desired], [OptionDataCompressionDelay_Actual], [Storage_Desired], [Storage_Actual], [StorageType_Desired], [StorageType_Actual], [PartitionFunction_Desired], [PartitionFunction_Actual], [PartitionColumn_Desired], [PartitionColumn_Actual], [AllColsInTableSize_Estimated], [NumFixedCols_Estimated], [NumVarCols_Estimated], [NumCols_Estimated], [FixedColsSize_Estimated], [VarColsSize_Estimated], [ColsSize_Estimated], [NumRows_Actual], [IndexSizeMB_Actual], [DriveLetter], [IsIndexLarge], [IndexMeetsMinimumSize], [Fragmentation], [FragmentationType], [AreDropRecreateOptionsChanging], [AreRebuildOptionsChanging], [AreRebuildOnlyOptionsChanging], [AreReorgOptionsChanging], [AreSetOptionsChanging], [IsColumnListChanging], [IsFilterChanging], [IsClusteredChanging], [IsPartitioningChanging], [IsDataCompressionChanging], [IsDataCompressionDelayChanging], [IsStorageChanging], [NumPages_Actual], [TotalPartitionsInIndex], [NeedsPartitionLevelOperations]) SELECT [DatabaseName], [SchemaName], [TableName], [IndexName], [IsIndexMissingFromSQLServer], [IsClustered_Desired], [IsClustered_Actual], [ColumnList_Desired], [ColumnList_Actual], [IsFiltered_Desired], [IsFiltered_Actual], [FilterPredicate_Desired], [FilterPredicate_Actual], [OptionDataCompression_Desired], [OptionDataCompression_Actual], [OptionDataCompressionDelay_Desired], [OptionDataCompressionDelay_Actual], [Storage_Desired], [Storage_Actual], [StorageType_Desired], [StorageType_Actual], [PartitionFunction_Desired], [PartitionFunction_Actual], [PartitionColumn_Desired], [PartitionColumn_Actual], [AllColsInTableSize_Estimated], [NumFixedCols_Estimated], [NumVarCols_Estimated], [NumCols_Estimated], [FixedColsSize_Estimated], [VarColsSize_Estimated], [ColsSize_Estimated], [NumRows_Actual], [IndexSizeMB_Actual], [DriveLetter], [IsIndexLarge], [IndexMeetsMinimumSize], [Fragmentation], [FragmentationType], [AreDropRecreateOptionsChanging], [AreRebuildOptionsChanging], [AreRebuildOnlyOptionsChanging], [AreReorgOptionsChanging], [AreSetOptionsChanging], [IsColumnListChanging], [IsFilterChanging], [IsClusteredChanging], [IsPartitioningChanging], [IsDataCompressionChanging], [IsDataCompressionDelayChanging], [IsStorageChanging], [NumPages_Actual], [TotalPartitionsInIndex], [NeedsPartitionLevelOperations] FROM [DDI].[RG_Recovery_1_IndexesColumnStore]
GO
UPDATE STATISTICS [DDI].[IndexesColumnStore] WITH FULLSCAN, NORECOMPUTE
GO
DROP TABLE [DDI].[RG_Recovery_1_IndexesColumnStore]
GO
PRINT N'Rebuilding [DDI].[IndexesRowStore]'
GO
CREATE TABLE [DDI].[RG_Recovery_32_IndexesRowStore]
(
[DatabaseName] [nvarchar] (128) NOT NULL,
[SchemaName] [nvarchar] (128) NOT NULL,
[TableName] [nvarchar] (128) NOT NULL,
[IndexName] [nvarchar] (128) NOT NULL,
[IsIndexMissingFromSQLServer] [bit] NOT NULL CONSTRAINT [RG_Recovery_33_IndexesRowStore] DEFAULT ((0)),
[IsUnique_Desired] [bit] NOT NULL,
[IsUnique_Actual] [bit] NULL,
[IsPrimaryKey_Desired] [bit] NOT NULL,
[IsPrimaryKey_Actual] [bit] NULL,
[IsUniqueConstraint_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_34_IndexesRowStore] DEFAULT ((0)),
...
[FilterPredicate_Desired] [varchar] (max) NULL,
[FilterPredicate_Actual] [varchar] (max) NULL,
[Fillfactor_Desired] [tinyint] NOT NULL CONSTRAINT [RG_Recovery_35_IndexesRowStore] DEFAULT ((90)),
[Fillfactor_Actual] [tinyint] NULL,
[OptionPadIndex_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_36_IndexesRowStore] DEFAULT ((1)),
[OptionPadIndex_Actual] [bit] NULL,
[OptionStatisticsNoRecompute_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_37_IndexesRowStore] DEFAULT ((0)),
[OptionStatisticsNoRecompute_Actual] [bit] NULL,
[OptionStatisticsIncremental_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_38_IndexesRowStore] DEFAULT ((0)),
[OptionStatisticsIncremental_Actual] [bit] NULL,
[OptionIgnoreDupKey_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_39_IndexesRowStore] DEFAULT ((0)),
[OptionIgnoreDupKey_Actual] [bit] NULL,
[OptionResumable_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_40_IndexesRowStore] DEFAULT ((0)),
[OptionResumable_Actual] [bit] NULL,
[OptionMaxDuration_Desired] [smallint] NOT NULL CONSTRAINT [RG_Recovery_41_IndexesRowStore] DEFAULT ((0)),
[OptionMaxDuration_Actual] [smallint] NULL,
[OptionAllowRowLocks_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_42_IndexesRowStore] DEFAULT ((1)),
[OptionAllowRowLocks_Actual] [bit] NULL,
[OptionAllowPageLocks_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_43_IndexesRowStore] DEFAULT ((1)),
[OptionAllowPageLocks_Actual] [bit] NULL,
[OptionDataCompression_Desired] [nvarchar] (60) NOT NULL CONSTRAINT [RG_Recovery_44_IndexesRowStore] DEFAULT ('PAGE'),
[OptionDataCompression_Actual] [nvarchar] (60) NULL,
[OptionDataCompressionDelay_Desired] [bit] NOT NULL CONSTRAINT [RG_Recovery_45_IndexesRowStore] DEFAULT ((0)),
[OptionDataCompressionDelay_Actual] [bit] NOT NULL CONSTRAINT [RG_Recovery_46_IndexesRowStore] DEFAULT ((0)),
[Storage_Desired] [nvarchar] (128) NOT NULL,
[Storage_Actual] [nvarchar] (128) NULL,
[StorageType_Desired] [nvarchar] (120) NULL,
[StorageType_Actual] [nvarchar] (120) NULL,
...
[PartitionColumn_Desired] [nvarchar] (128) NULL,
[PartitionColumn_Actual] [nvarchar] (128) NULL,
[NumRows_Actual] [bigint] NOT NULL CONSTRAINT [RG_Recovery_47_IndexesRowStore] DEFAULT ((0)),
[AllColsInTableSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_48_IndexesRowStore] DEFAULT ((0)),
[NumFixedKeyCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_49_IndexesRowStore] DEFAULT ((0)),
[NumVarKeyCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_50_IndexesRowStore] DEFAULT ((0)),
[NumKeyCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_51_IndexesRowStore] DEFAULT ((0)),
[NumFixedInclCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_52_IndexesRowStore] DEFAULT ((0)),
[NumVarInclCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_53_IndexesRowStore] DEFAULT ((0)),
[NumInclCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_54_IndexesRowStore] DEFAULT ((0)),
[NumFixedCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_55_IndexesRowStore] DEFAULT ((0)),
[NumVarCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_56_IndexesRowStore] DEFAULT ((0)),
[NumCols_Estimated] [smallint] NOT NULL CONSTRAINT [RG_Recovery_57_IndexesRowStore] DEFAULT ((0)),
[FixedKeyColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_58_IndexesRowStore] DEFAULT ((0)),
[VarKeyColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_59_IndexesRowStore] DEFAULT ((0)),
[KeyColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_60_IndexesRowStore] DEFAULT ((0)),
[FixedInclColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_61_IndexesRowStore] DEFAULT ((0)),
[VarInclColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_62_IndexesRowStore] DEFAULT ((0)),
[InclColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_63_IndexesRowStore] DEFAULT ((0)),
[FixedColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_64_IndexesRowStore] DEFAULT ((0)),
[VarColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_65_IndexesRowStore] DEFAULT ((0)),
[ColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_66_IndexesRowStore] DEFAULT ((0)),
[PKColsSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_67_IndexesRowStore] DEFAULT ((0)),
[NullBitmap_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_68_IndexesRowStore] DEFAULT ((0)),
[Uniqueifier_Estimated] [tinyint] NOT NULL CONSTRAINT [RG_Recovery_69_IndexesRowStore] DEFAULT ((0)),
[TotalRowSize_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_70_IndexesRowStore] DEFAULT ((0)),
[NonClusteredIndexRowLocator_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_71_IndexesRowStore] DEFAULT ((0)),
[NumRowsPerPage_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_72_IndexesRowStore] DEFAULT ((0)),
[NumFreeRowsPerPage_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_73_IndexesRowStore] DEFAULT ((0)),
[NumLeafPages_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_74_IndexesRowStore] DEFAULT ((0)),
[LeafSpaceUsed_Estimated] [decimal] (18, 2) NOT NULL CONSTRAINT [RG_Recovery_75_IndexesRowStore] DEFAULT ((0)),
[LeafSpaceUsedMB_Estimated] [decimal] (10, 2) NOT NULL CONSTRAINT [RG_Recovery_76_IndexesRowStore] DEFAULT ((0)),
[NumNonLeafLevelsInIndex_Estimated] [tinyint] NOT NULL CONSTRAINT [RG_Recovery_77_IndexesRowStore] DEFAULT ((0)),
[NumIndexPages_Estimated] [int] NOT NULL CONSTRAINT [RG_Recovery_78_IndexesRowStore] DEFAULT ((0)),
[IndexSizeMB_Estimated] [decimal] (10, 2) NOT NULL CONSTRAINT [RG_Recovery_79_IndexesRowStore] DEFAULT ((0)),
[IndexSizeMB_Actual] [decimal] (10, 2) NOT NULL CONSTRAINT [RG_Recovery_80_IndexesRowStore] DEFAULT ((0)),
[DriveLetter] [char] (1) NULL,
[IsIndexLarge] [bit] NOT NULL CONSTRAINT [RG_Recovery_81_IndexesRowStore] DEFAULT ((0)),
[IndexMeetsMinimumSize] [bit] NOT NULL CONSTRAINT [RG_Recovery_82_IndexesRowStore] DEFAULT ((0)),
[Fragmentation] [float] NOT NULL CONSTRAINT [RG_Recovery_83_IndexesRowStore] DEFAULT ((0)),
[FragmentationType] [varchar] (5) NOT NULL CONSTRAINT [RG_Recovery_84_IndexesRowStore] DEFAULT ('None'),
[AreDropRecreateOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_85_IndexesRowStore] DEFAULT ((0)),
[AreRebuildOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_86_IndexesRowStore] DEFAULT ((0)),
[AreRebuildOnlyOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_87_IndexesRowStore] DEFAULT ((0)),
[AreReorgOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_88_IndexesRowStore] DEFAULT ((0)),
[AreSetOptionsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_89_IndexesRowStore] DEFAULT ((0)),
[IsUniquenessChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_90_IndexesRowStore] DEFAULT ((0)),
[IsPrimaryKeyChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_91_IndexesRowStore] DEFAULT ((0)),
[IsKeyColumnListChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_92_IndexesRowStore] DEFAULT ((0)),
[IsIncludedColumnListChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_93_IndexesRowStore] DEFAULT ((0)),
[IsFilterChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_94_IndexesRowStore] DEFAULT ((0)),
[IsClusteredChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_95_IndexesRowStore] DEFAULT ((0)),
[IsPartitioningChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_96_IndexesRowStore] DEFAULT ((0)),
[IsPadIndexChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_97_IndexesRowStore] DEFAULT ((0)),
[IsFillfactorChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_98_IndexesRowStore] DEFAULT ((0)),
[IsIgnoreDupKeyChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_99_IndexesRowStore] DEFAULT ((0)),
[IsStatisticsNoRecomputeChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_100_IndexesRowStore] DEFAULT ((0)),
[IsStatisticsIncrementalChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_101_IndexesRowStore] DEFAULT ((0)),
[IsAllowRowLocksChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_102_IndexesRowStore] DEFAULT ((0)),
[IsAllowPageLocksChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_103_IndexesRowStore] DEFAULT ((0)),
[IsDataCompressionChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_104_IndexesRowStore] DEFAULT ((0)),
[IsDataCompressionDelayChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_105_IndexesRowStore] DEFAULT ((0)),
[IsStorageChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_106_IndexesRowStore] DEFAULT ((0)),
[IndexHasLOBColumns] [bit] NOT NULL CONSTRAINT [RG_Recovery_107_IndexesRowStore] DEFAULT ((0)),
[NumPages_Actual] [int] NOT NULL CONSTRAINT [RG_Recovery_108_IndexesRowStore] DEFAULT ((0)),
[TotalPartitionsInIndex] [int] NOT NULL CONSTRAINT [RG_Recovery_109_IndexesRowStore] DEFAULT ((0)),
[NeedsPartitionLevelOperations] [bit] NOT NULL CONSTRAINT [RG_Recovery_110_IndexesRowStore] DEFAULT ((0))
)
GO
INSERT INTO [DDI].[RG_Recovery_32_IndexesRowStore]([DatabaseName], [SchemaName], [TableName], [IndexName], [IsIndexMissingFromSQLServer], [IsUnique_Desired], [IsUnique_Actual], [IsPrimaryKey_Desired], [IsPrimaryKey_Actual], [IsUniqueConstraint_Desired], [IsUniqueConstraint_Actual], [IsClustered_Desired], [IsClustered_Actual], [KeyColumnList_Desired], [KeyColumnList_Actual], [IncludedColumnList_Desired], [IncludedColumnList_Actual], [IsFiltered_Desired], [IsFiltered_Actual], [FilterPredicate_Desired], [FilterPredicate_Actual], [Fillfactor_Desired], [Fillfactor_Actual], [OptionPadIndex_Desired], [OptionPadIndex_Actual], [OptionStatisticsNoRecompute_Desired], [OptionStatisticsNoRecompute_Actual], [OptionStatisticsIncremental_Desired], [OptionStatisticsIncremental_Actual], [OptionIgnoreDupKey_Desired], [OptionIgnoreDupKey_Actual], [OptionResumable_Desired], [OptionResumable_Actual], [OptionMaxDuration_Desired], [OptionMaxDuration_Actual], [OptionAllowRowLocks_Desired], [OptionAllowRowLocks_Actual], [OptionAllowPageLocks_Desired], [OptionAllowPageLocks_Actual], [OptionDataCompression_Desired], [OptionDataCompression_Actual], [OptionDataCompressionDelay_Desired], [OptionDataCompressionDelay_Actual], [Storage_Desired], [Storage_Actual], [StorageType_Desired], [StorageType_Actual], [PartitionFunction_Desired], [PartitionFunction_Actual], [PartitionColumn_Desired], [PartitionColumn_Actual], [NumRows_Actual], [AllColsInTableSize_Estimated], [NumFixedKeyCols_Estimated], [NumVarKeyCols_Estimated], [NumKeyCols_Estimated], [NumFixedInclCols_Estimated], [NumVarInclCols_Estimated], [NumInclCols_Estimated], [NumFixedCols_Estimated], [NumVarCols_Estimated], [NumCols_Estimated], [FixedKeyColsSize_Estimated], [VarKeyColsSize_Estimated], [KeyColsSize_Estimated], [FixedInclColsSize_Estimated], [VarInclColsSize_Estimated], [InclColsSize_Estimated], [FixedColsSize_Estimated], [VarColsSize_Estimated], [ColsSize_Estimated], [PKColsSize_Estimated], [NullBitmap_Estimated], [Uniqueifier_Estimated], [TotalRowSize_Estimated], [NonClusteredIndexRowLocator_Estimated], [NumRowsPerPage_Estimated], [NumFreeRowsPerPage_Estimated], [NumLeafPages_Estimated], [LeafSpaceUsed_Estimated], [LeafSpaceUsedMB_Estimated], [NumNonLeafLevelsInIndex_Estimated], [NumIndexPages_Estimated], [IndexSizeMB_Estimated], [IndexSizeMB_Actual], [DriveLetter], [IsIndexLarge], [IndexMeetsMinimumSize], [Fragmentation], [FragmentationType], [AreDropRecreateOptionsChanging], [AreRebuildOptionsChanging], [AreRebuildOnlyOptionsChanging], [AreReorgOptionsChanging], [AreSetOptionsChanging], [IsUniquenessChanging], [IsPrimaryKeyChanging], [IsKeyColumnListChanging], [IsIncludedColumnListChanging], [IsFilterChanging], [IsClusteredChanging], [IsPartitioningChanging], [IsPadIndexChanging], [IsFillfactorChanging], [IsIgnoreDupKeyChanging], [IsStatisticsNoRecomputeChanging], [IsStatisticsIncrementalChanging], [IsAllowRowLocksChanging], [IsAllowPageLocksChanging], [IsDataCompressionChanging], [IsDataCompressionDelayChanging], [IsStorageChanging], [IndexHasLOBColumns], [NumPages_Actual], [TotalPartitionsInIndex], [NeedsPartitionLevelOperations]) SELECT [DatabaseName], [SchemaName], [TableName], [IndexName], [IsIndexMissingFromSQLServer], [IsUnique_Desired], [IsUnique_Actual], [IsPrimaryKey_Desired], [IsPrimaryKey_Actual], [IsUniqueConstraint_Desired], [IsUniqueConstraint_Actual], [IsClustered_Desired], [IsClustered_Actual], [KeyColumnList_Desired], [KeyColumnList_Actual], [IncludedColumnList_Desired], [IncludedColumnList_Actual], [IsFiltered_Desired], [IsFiltered_Actual], [FilterPredicate_Desired], [FilterPredicate_Actual], [Fillfactor_Desired], [Fillfactor_Actual], [OptionPadIndex_Desired], [OptionPadIndex_Actual], [OptionStatisticsNoRecompute_Desired], [OptionStatisticsNoRecompute_Actual], [OptionStatisticsIncremental_Desired], [OptionStatisticsIncremental_Actual], [OptionIgnoreDupKey_Desired], [OptionIgnoreDupKey_Actual], [OptionResumable_Desired], [OptionResumable_Actual], [OptionMaxDuration_Desired], [OptionMaxDuration_Actual], [OptionAllowRowLocks_Desired], [OptionAllowRowLocks_Actual], [OptionAllowPageLocks_Desired], [OptionAllowPageLocks_Actual], [OptionDataCompression_Desired], [OptionDataCompression_Actual], [OptionDataCompressionDelay_Desired], [OptionDataCompressionDelay_Actual], [Storage_Desired], [Storage_Actual], [StorageType_Desired], [StorageType_Actual], [PartitionFunction_Desired], [PartitionFunction_Actual], [PartitionColumn_Desired], [PartitionColumn_Actual], [NumRows_Actual], [AllColsInTableSize_Estimated], [NumFixedKeyCols_Estimated], [NumVarKeyCols_Estimated], [NumKeyCols_Estimated], [NumFixedInclCols_Estimated], [NumVarInclCols_Estimated], [NumInclCols_Estimated], [NumFixedCols_Estimated], [NumVarCols_Estimated], [NumCols_Estimated], [FixedKeyColsSize_Estimated], [VarKeyColsSize_Estimated], [KeyColsSize_Estimated], [FixedInclColsSize_Estimated], [VarInclColsSize_Estimated], [InclColsSize_Estimated], [FixedColsSize_Estimated], [VarColsSize_Estimated], [ColsSize_Estimated], [PKColsSize_Estimated], [NullBitmap_Estimated], [Uniqueifier_Estimated], [TotalRowSize_Estimated], [NonClusteredIndexRowLocator_Estimated], [NumRowsPerPage_Estimated], [NumFreeRowsPerPage_Estimated], [NumLeafPages_Estimated], [LeafSpaceUsed_Estimated], [LeafSpaceUsedMB_Estimated], [NumNonLeafLevelsInIndex_Estimated], [NumIndexPages_Estimated], [IndexSizeMB_Estimated], [IndexSizeMB_Actual], [DriveLetter], [IsIndexLarge], [IndexMeetsMinimumSize], [Fragmentation], [FragmentationType], [AreDropRecreateOptionsChanging], [AreRebuildOptionsChanging], [AreRebuildOnlyOptionsChanging], [AreReorgOptionsChanging], [AreSetOptionsChanging], [IsUniquenessChanging], [IsPrimaryKeyChanging], [IsKeyColumnListChanging], [IsIncludedColumnListChanging], [IsFilterChanging], [IsClusteredChanging], [IsPartitioningChanging], [IsPadIndexChanging], [IsFillfactorChanging], [IsIgnoreDupKeyChanging], [IsStatisticsNoRecomputeChanging], [IsStatisticsIncrementalChanging], [IsAllowRowLocksChanging], [IsAllowPageLocksChanging], [IsDataCompressionChanging], [IsDataCompressionDelayChanging], [IsStorageChanging], [IndexHasLOBColumns], [NumPages_Actual], [TotalPartitionsInIndex], [NeedsPartitionLevelOperations] FROM [DDI].[IndexesRowStore]
GO
...
GO
INSERT INTO [DDI].[IndexesRowStore]([DatabaseName], [SchemaName], [TableName], [IndexName], [IsIndexMissingFromSQLServer], [IsUnique_Desired], [IsUnique_Actual], [IsPrimaryKey_Desired], [IsPrimaryKey_Actual], [IsUniqueConstraint_Desired], [IsUniqueConstraint_Actual], [IsClustered_Desired], [IsClustered_Actual], [KeyColumnList_Desired], [KeyColumnList_Actual], [IncludedColumnList_Desired], [IncludedColumnList_Actual], [IsFiltered_Desired], [IsFiltered_Actual], [FilterPredicate_Desired], [FilterPredicate_Actual], [Fillfactor_Desired], [Fillfactor_Actual], [OptionPadIndex_Desired], [OptionPadIndex_Actual], [OptionStatisticsNoRecompute_Desired], [OptionStatisticsNoRecompute_Actual], [OptionStatisticsIncremental_Desired], [OptionStatisticsIncremental_Actual], [OptionIgnoreDupKey_Desired], [OptionIgnoreDupKey_Actual], [OptionResumable_Desired], [OptionResumable_Actual], [OptionMaxDuration_Desired], [OptionMaxDuration_Actual], [OptionAllowRowLocks_Desired], [OptionAllowRowLocks_Actual], [OptionAllowPageLocks_Desired], [OptionAllowPageLocks_Actual], [OptionDataCompression_Desired], [OptionDataCompression_Actual], [OptionDataCompressionDelay_Desired], [OptionDataCompressionDelay_Actual], [Storage_Desired], [Storage_Actual], [StorageType_Desired], [StorageType_Actual], [PartitionFunction_Desired], [PartitionFunction_Actual], [PartitionColumn_Desired], [PartitionColumn_Actual], [NumRows_Actual], [AllColsInTableSize_Estimated], [NumFixedKeyCols_Estimated], [NumVarKeyCols_Estimated], [NumKeyCols_Estimated], [NumFixedInclCols_Estimated], [NumVarInclCols_Estimated], [NumInclCols_Estimated], [NumFixedCols_Estimated], [NumVarCols_Estimated], [NumCols_Estimated], [FixedKeyColsSize_Estimated], [VarKeyColsSize_Estimated], [KeyColsSize_Estimated], [FixedInclColsSize_Estimated], [VarInclColsSize_Estimated], [InclColsSize_Estimated], [FixedColsSize_Estimated], [VarColsSize_Estimated], [ColsSize_Estimated], [PKColsSize_Estimated], [NullBitmap_Estimated], [Uniqueifier_Estimated], [TotalRowSize_Estimated], [NonClusteredIndexRowLocator_Estimated], [NumRowsPerPage_Estimated], [NumFreeRowsPerPage_Estimated], [NumLeafPages_Estimated], [LeafSpaceUsed_Estimated], [LeafSpaceUsedMB_Estimated], [NumNonLeafLevelsInIndex_Estimated], [NumIndexPages_Estimated], [IndexSizeMB_Estimated], [IndexSizeMB_Actual], [DriveLetter], [IsIndexLarge], [IndexMeetsMinimumSize], [Fragmentation], [FragmentationType], [AreDropRecreateOptionsChanging], [AreRebuildOptionsChanging], [AreRebuildOnlyOptionsChanging], [AreReorgOptionsChanging], [AreSetOptionsChanging], [IsUniquenessChanging], [IsPrimaryKeyChanging], [IsKeyColumnListChanging], [IsIncludedColumnListChanging], [IsFilterChanging], [IsClusteredChanging], [IsPartitioningChanging], [IsPadIndexChanging], [IsFillfactorChanging], [IsIgnoreDupKeyChanging], [IsStatisticsNoRecomputeChanging], [IsStatisticsIncrementalChanging], [IsAllowRowLocksChanging], [IsAllowPageLocksChanging], [IsDataCompressionChanging], [IsDataCompressionDelayChanging], [IsStorageChanging], [IndexHasLOBColumns], [NumPages_Actual], [TotalPartitionsInIndex], [NeedsPartitionLevelOperations]) SELECT [DatabaseName], [SchemaName], [TableName], [IndexName], [IsIndexMissingFromSQLServer], [IsUnique_Desired], [IsUnique_Actual], [IsPrimaryKey_Desired], [IsPrimaryKey_Actual], [IsUniqueConstraint_Desired], [IsUniqueConstraint_Actual], [IsClustered_Desired], [IsClustered_Actual], [KeyColumnList_Desired], [KeyColumnList_Actual], [IncludedColumnList_Desired], [IncludedColumnList_Actual], [IsFiltered_Desired], [IsFiltered_Actual], [FilterPredicate_Desired], [FilterPredicate_Actual], [Fillfactor_Desired], [Fillfactor_Actual], [OptionPadIndex_Desired], [OptionPadIndex_Actual], [OptionStatisticsNoRecompute_Desired], [OptionStatisticsNoRecompute_Actual], [OptionStatisticsIncremental_Desired], [OptionStatisticsIncremental_Actual], [OptionIgnoreDupKey_Desired], [OptionIgnoreDupKey_Actual], [OptionResumable_Desired], [OptionResumable_Actual], [OptionMaxDuration_Desired], [OptionMaxDuration_Actual], [OptionAllowRowLocks_Desired], [OptionAllowRowLocks_Actual], [OptionAllowPageLocks_Desired], [OptionAllowPageLocks_Actual], [OptionDataCompression_Desired], [OptionDataCompression_Actual], [OptionDataCompressionDelay_Desired], [OptionDataCompressionDelay_Actual], [Storage_Desired], [Storage_Actual], [StorageType_Desired], [StorageType_Actual], [PartitionFunction_Desired], [PartitionFunction_Actual], [PartitionColumn_Desired], [PartitionColumn_Actual], [NumRows_Actual], [AllColsInTableSize_Estimated], [NumFixedKeyCols_Estimated], [NumVarKeyCols_Estimated], [NumKeyCols_Estimated], [NumFixedInclCols_Estimated], [NumVarInclCols_Estimated], [NumInclCols_Estimated], [NumFixedCols_Estimated], [NumVarCols_Estimated], [NumCols_Estimated], [FixedKeyColsSize_Estimated], [VarKeyColsSize_Estimated], [KeyColsSize_Estimated], [FixedInclColsSize_Estimated], [VarInclColsSize_Estimated], [InclColsSize_Estimated], [FixedColsSize_Estimated], [VarColsSize_Estimated], [ColsSize_Estimated], [PKColsSize_Estimated], [NullBitmap_Estimated], [Uniqueifier_Estimated], [TotalRowSize_Estimated], [NonClusteredIndexRowLocator_Estimated], [NumRowsPerPage_Estimated], [NumFreeRowsPerPage_Estimated], [NumLeafPages_Estimated], [LeafSpaceUsed_Estimated], [LeafSpaceUsedMB_Estimated], [NumNonLeafLevelsInIndex_Estimated], [NumIndexPages_Estimated], [IndexSizeMB_Estimated], [IndexSizeMB_Actual], [DriveLetter], [IsIndexLarge], [IndexMeetsMinimumSize], [Fragmentation], [FragmentationType], [AreDropRecreateOptionsChanging], [AreRebuildOptionsChanging], [AreRebuildOnlyOptionsChanging], [AreReorgOptionsChanging], [AreSetOptionsChanging], [IsUniquenessChanging], [IsPrimaryKeyChanging], [IsKeyColumnListChanging], [IsIncludedColumnListChanging], [IsFilterChanging], [IsClusteredChanging], [IsPartitioningChanging], [IsPadIndexChanging], [IsFillfactorChanging], [IsIgnoreDupKeyChanging], [IsStatisticsNoRecomputeChanging], [IsStatisticsIncrementalChanging], [IsAllowRowLocksChanging], [IsAllowPageLocksChanging], [IsDataCompressionChanging], [IsDataCompressionDelayChanging], [IsStorageChanging], [IndexHasLOBColumns], [NumPages_Actual], [TotalPartitionsInIndex], [NeedsPartitionLevelOperations] FROM [DDI].[RG_Recovery_32_IndexesRowStore]
GO
UPDATE STATISTICS [DDI].[IndexesRowStore] WITH FULLSCAN, NORECOMPUTE
GO
DROP TABLE [DDI].[RG_Recovery_32_IndexesRowStore]
GO
PRINT N'Rebuilding [DDI].[Tables]'
GO
CREATE TABLE [DDI].[RG_Recovery_111_Tables]
(
[DatabaseName] [nvarchar] (128) NOT NULL,
[SchemaName] [nvarchar] (128) NOT NULL,
[TableName] [nvarchar] (128) NOT NULL,
...
[IntendToPartition] [bit] NOT NULL CONSTRAINT [RG_Recovery_112_Tables] DEFAULT ((0)),
[ReadyToQueue] [bit] NOT NULL CONSTRAINT [RG_Recovery_113_Tables] DEFAULT ((0)),
[AreIndexesFragmented] [bit] NOT NULL CONSTRAINT [RG_Recovery_114_Tables] DEFAULT ((0)),
[AreIndexesBeingUpdated] [bit] NOT NULL CONSTRAINT [RG_Recovery_115_Tables] DEFAULT ((0)),
[AreIndexesMissing] [bit] NOT NULL CONSTRAINT [RG_Recovery_116_Tables] DEFAULT ((0)),
[IsClusteredIndexBeingDropped] [bit] NOT NULL CONSTRAINT [RG_Recovery_117_Tables] DEFAULT ((0)),
[WhichUniqueConstraintIsBeingDropped] [varchar] (10) NOT NULL CONSTRAINT [RG_Recovery_118_Tables] DEFAULT ('None'),
[IsStorageChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_119_Tables] DEFAULT ((0)),
[NeedsTransaction] [bit] NOT NULL CONSTRAINT [RG_Recovery_120_Tables] DEFAULT ((0)),
[AreStatisticsChanging] [bit] NOT NULL CONSTRAINT [RG_Recovery_121_Tables] DEFAULT ((0)),
...
[IsFixedSize] [bit] NOT NULL CONSTRAINT [RG_Recovery_123_IndexColumns] DEFAULT ((0)),
[ColumnSize] [decimal] (10, 2) NOT NULL CONSTRAINT [RG_Recovery_124_IndexColumns] DEFAULT ((0))
)
GO
INSERT INTO [DDI].[RG_Recovery_122_IndexColumns]([DatabaseName], [SchemaName], [TableName], [IndexName], [ColumnName], [IsKeyColumn], [KeyColumnPosition], [IsIncludedColumn], [IncludedColumnPosition], [IsFixedSize], [ColumnSize]) SELECT [DatabaseName], [SchemaName], [TableName], [IndexName], [ColumnName], [IsKeyColumn], [KeyColumnPosition], [IsIncludedColumn], [IncludedColumnPosition], [IsFixedSize], [ColumnSize] FROM [DDI].[IndexColumns]
GO
...
GO
INSERT INTO [DDI].[IndexColumns]([DatabaseName], [SchemaName], [TableName], [IndexName], [ColumnName], [IsKeyColumn], [KeyColumnPosition], [IsIncludedColumn], [IncludedColumnPosition], [IsFixedSize], [ColumnSize]) SELECT [DatabaseName], [SchemaName], [TableName], [IndexName], [ColumnName], [IsKeyColumn], [KeyColumnPosition], [IsIncludedColumn], [IncludedColumnPosition], [IsFixedSize], [ColumnSize] FROM [DDI].[RG_Recovery_122_IndexColumns]
GO
UPDATE STATISTICS [DDI].[IndexColumns] WITH FULLSCAN, NORECOMPUTE
GO
DROP TABLE [DDI].[RG_Recovery_122_IndexColumns]
GO
PRINT N'Rebuilding [DDI].[DefaultConstraints]'
GO
CREATE TABLE [DDI].[RG_Recovery_125_DefaultConstraints]
(
[DatabaseName] [nvarchar] (128) NOT NULL,
[SchemaName] [nvarchar] (128) NOT NULL,
[TableName] [nvarchar] (128) NOT NULL,
...
GO
INSERT INTO [DDI].[RG_Recovery_125_DefaultConstraints]([DatabaseName], [SchemaName], [TableName], [ColumnName], [DefaultDefinition], [DefaultConstraintName]) SELECT [DatabaseName], [SchemaName], [TableName], [ColumnName], [DefaultDefinition], [DefaultConstraintName] FROM [DDI].[DefaultConstraints]
GO
...
GO
INSERT INTO [DDI].[DefaultConstraints]([DatabaseName], [SchemaName], [TableName], [ColumnName], [DefaultDefinition], [DefaultConstraintName]) SELECT [DatabaseName], [SchemaName], [TableName], [ColumnName], [DefaultDefinition], [DefaultConstraintName] FROM [DDI].[RG_Recovery_125_DefaultConstraints]
GO
UPDATE STATISTICS [DDI].[DefaultConstraints] WITH FULLSCAN, NORECOMPUTE
GO
DROP TABLE [DDI].[RG_Recovery_125_DefaultConstraints]
GO
PRINT N'Rebuilding [DDI].[Statistics]'
GO
CREATE TABLE [DDI].[RG_Recovery_126_Statistics]
(
[DatabaseName] [nvarchar] (128) NOT NULL,
[SchemaName] [nvarchar] (128) NOT NULL,
[TableName] [nvarchar] (128) NOT NULL,
[StatisticsName] [sys].[sysname] NOT NULL,
[IsStatisticsMissingFromSQLServer] [bit] NOT NULL CONSTRAINT [RG_Recovery_127_Statistics] DEFAULT ((0)),
...
[SampleSizePct_Actual] [tinyint] NOT NULL CONSTRAINT [RG_Recovery_128_Statistics] DEFAULT ((0)),
[IsFiltered_Desired] [bit] NOT NULL,
[IsFiltered_Actual] [bit] NOT NULL CONSTRAINT [RG_Recovery_129_Statistics] DEFAULT ((0)),
[FilterPredicate_Desired] [varchar] (max) NULL,
[FilterPredicate_Actual] [nvarchar] (max) NULL,
[IsIncremental_Desired] [bit] NOT NULL,
[IsIncremental_Actual] [bit] NOT NULL CONSTRAINT [RG_Recovery_130_Statistics] DEFAULT ((0)),
[NoRecompute_Desired] [bit] NOT NULL,
[NoRecompute_Actual] [bit] NOT NULL CONSTRAINT [RG_Recovery_131_Statistics] DEFAULT ((0)),
[LowerSampleSizeToDesired] [bit] NOT NULL,
[ReadyToQueue] [bit] NOT NULL CONSTRAINT [RG_Recovery_132_Statistics] DEFAULT ((0)),
[DoesSampleSizeNeedUpdate] [bit] NOT NULL CONSTRAINT [RG_Recovery_133_Statistics] DEFAULT ((0)),
[IsStatisticsMissing] [bit] NOT NULL CONSTRAINT [RG_Recovery_134_Statistics] DEFAULT ((0)),
[HasFilterChanged] [bit] NOT NULL CONSTRAINT [RG_Recovery_135_Statistics] DEFAULT ((0)),
[HasIncrementalChanged] [bit] NOT NULL CONSTRAINT [RG_Recovery_136_Statistics] DEFAULT ((0)),
[HasNoRecomputeChanged] [bit] NOT NULL CONSTRAINT [RG_Recovery_137_Statistics] DEFAULT ((0)),
...
[TableChildOperationId] [smallint] NOT NULL CONSTRAINT [RG_Recovery_142_Queue] DEFAULT ((0)),
[SQLStatement] [varchar] (max) NOT NULL,
[SeqNo] [int] NOT NULL,
[DateTimeInserted] [datetime2] NOT NULL CONSTRAINT [RG_Recovery_143_Queue] DEFAULT (sysdatetime()),
[InProgress] [bit] NOT NULL CONSTRAINT [RG_Recovery_144_Queue] DEFAULT ((0)),
[RunStatus] [varchar] (7) NOT NULL CONSTRAINT [RG_Recovery_145_Queue] DEFAULT ('Running'),
[ErrorMessage] [varchar] (max) NULL,
[TransactionId] [uniqueidentifier] NULL,
[BatchId] [uniqueidentifier] NOT NULL,
[ExitTableLoopOnError] [bit] NOT NULL CONSTRAINT [RG_Recovery_146_Queue] DEFAULT ((0))
)
GO
INSERT INTO [DDI].[RG_Recovery_140_Queue]([DatabaseName], [SchemaName], [TableName], [IndexName], [PartitionNumber], [IndexSizeInMB], [ParentSchemaName], [ParentTableName], [ParentIndexName], [IndexOperation], [IsOnlineOperation], [TableChildOperationId], [SQLStatement], [SeqNo], [DateTimeInserted], [InProgress], [RunStatus], [ErrorMessage], [TransactionId], [BatchId], [ExitTableLoopOnError]) SELECT [DatabaseName], [SchemaName], [TableName], [IndexName], [PartitionNumber], [IndexSizeInMB], [ParentSchemaName], [ParentTableName], [ParentIndexName], [IndexOperation], [IsOnlineOperation], [TableChildOperationId], [SQLStatement], [SeqNo], [DateTimeInserted], [InProgress], [RunStatus], [ErrorMessage], [TransactionId], [BatchId], [ExitTableLoopOnError] FROM [DDI].[Queue]
GO
...
GO
PRINT N'Disabling constraints on [DDI].[Tables]'
GO
