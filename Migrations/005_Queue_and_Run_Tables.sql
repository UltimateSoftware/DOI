...
GO
IF OBJECT_ID('[DDI].[Queue]') IS NULL
...
GO
IF OBJECT_ID('[DDI].[Chk_Queue_IndexOperation]') IS NULL
...
GO
IF OBJECT_ID('[DDI].[FK_Run_PartitionState_Tables]') IS NULL
...
GO
IF OBJECT_ID('[DDI].[FK_Run_PartitionState_Tables]') IS NOT NULL
