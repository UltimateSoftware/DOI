...
GO
ALTER TABLE [DDI].[Queue] ADD CONSTRAINT [PK_Queue] PRIMARY KEY CLUSTERED  ([SchemaName], [TableName], [IndexName], [PartitionNumber], [IndexOperation], [TableChildOperationId])
GO
