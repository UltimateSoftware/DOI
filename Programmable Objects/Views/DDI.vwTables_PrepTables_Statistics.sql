IF OBJECT_ID('[DDI].[vwTables_PrepTables_Statistics]') IS NOT NULL
	DROP VIEW [DDI].[vwTables_PrepTables_Statistics];
...
/*
	SELECT	*
	FROM  DDI.vwTables_PrepTables_Statistics FNS
...
END' 
	...
	FROM  DDI.vwTables_PrepTables T
