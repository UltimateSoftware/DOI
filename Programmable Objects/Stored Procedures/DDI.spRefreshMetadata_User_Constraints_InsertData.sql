IF OBJECT_ID('[DDI].[spRefreshMetadata_User_Constraints_InsertData]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_User_Constraints_InsertData];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_User_Constraints_InsertData]
AS
