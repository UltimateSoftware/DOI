IF OBJECT_ID('[DDI].[spDropRecreateSchemaBoundObjectsOnTable]') IS NOT NULL
	DROP PROCEDURE [DDI].[spDropRecreateSchemaBoundObjectsOnTable];
...
CREATE   PROCEDURE [DDI].[spDropRecreateSchemaBoundObjectsOnTable]
    @SchemaName SYSNAME,
    @TableName SYSNAME,
