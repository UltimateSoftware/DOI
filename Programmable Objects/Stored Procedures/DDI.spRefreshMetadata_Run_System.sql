IF OBJECT_ID('[DDI].[spRefreshMetadata_Run_System]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_Run_System];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_Run_System]
    @Debug BIT = 0
AS
