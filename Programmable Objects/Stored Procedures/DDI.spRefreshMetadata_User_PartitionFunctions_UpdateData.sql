IF OBJECT_ID('[DDI].[spRefreshMetadata_User_PartitionFunctions_UpdateData]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_User_PartitionFunctions_UpdateData];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_User_PartitionFunctions_UpdateData]
