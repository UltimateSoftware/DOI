IF OBJECT_ID('[DDI].[spRun_RenameStatistics]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRun_RenameStatistics];
...
CREATE   PROCEDURE [DDI].[spRun_RenameStatistics]
...
FROM DDI.SysStats st
    ...
    INNER JOIN DDI.Tables T2 ON d.name = T2.DatabaseName
