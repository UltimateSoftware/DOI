IF OBJECT_ID('[DDI].[spRefreshMetadata_System_SysCheckConstraints_CreateTables]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_System_SysCheckConstraints_CreateTables];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_System_SysCheckConstraints_CreateTables]
...
DROP TABLE IF EXISTS DDI.SysCheckConstraints
