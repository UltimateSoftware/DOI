IF OBJECT_ID('[DDI].[spRefreshMetadata_User_IndexesColumnStore_CreateTables]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_User_IndexesColumnStore_CreateTables];
...
--GO
    ...
    IF OBJECT_ID('DDI.IndexColumnStorePartitions', 'U') IS NOT NULL
        AND OBJECT_ID('DDI.FK_IndexColumnStorePartitions_IndexesColumnStore', 'F') IS NULL
    BEGIN
        ALTER TABLE [DDI].[IndexColumnStorePartitions] ADD 
