IF OBJECT_ID('[DDI].[spRefreshMetadata_User_ForeignKeys_InsertData]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_User_ForeignKeys_InsertData];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_User_ForeignKeys_InsertData]
...
DELETE DDI.ForeignKeys

INSERT [DDI].[ForeignKeys] 
...
--		,(N'PaymentReporting'   ,N'dbo'		        , N'BankTransactions'			            , N'PayId'														, N'dbo'		        , N'Pays'												, N'PayId')
		...
		,(N'PaymentReporting'   ,N'dbo'		        , N'LiabilityCollections'		            , N'PaymentMethod'												, N'DataMart'	        , N'LiabilityCollectionPaymentMethodDim'				, N'LiabilityCollectionPaymentMethodKey')
		...
		,(N'PaymentReporting'   ,N'dbo'		        , N'NettedCollections'			            , N'PaymentMethod'												, N'DataMart'	        , N'LiabilityCollectionPaymentMethodDim'				, N'LiabilityCollectionPaymentMethodKey')
