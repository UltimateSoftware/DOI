IF OBJECT_ID('[DDI].[spRefreshMetadata_User_IndexesRowStore_CreateTables]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_User_IndexesRowStore_CreateTables];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_User_IndexesRowStore_CreateTables]
...
/*			CONSTRAINT Chk_IndexesRowStore_FilterPredicate
    ...
    ALTER TABLE [DDI].[IndexesRowStore] ADD INDEX IDX_IndexesRowStore_IndexName NONCLUSTERED ([IndexName])

    ALTER TABLE [DDI].[IndexRowStorePartitions] ADD 
        CONSTRAINT FK_IndexRowStorePartitions_IndexesRowStore
            FOREIGN KEY(DatabaseName, SchemaName, TableName, IndexName)
                REFERENCES DDI.IndexesRowStore(DatabaseName, SchemaName, TableName, IndexName)
