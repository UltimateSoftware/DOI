IF OBJECT_ID('[DDI].[spRefreshMetadata_User_IndexPartitions_RowStore_CreateTables]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_User_IndexPartitions_RowStore_CreateTables];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_User_IndexPartitions_RowStore_CreateTables]
