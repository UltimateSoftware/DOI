IF OBJECT_ID('[DDI].[spRefreshMetadata_User_Statistics_CreateTables]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_User_Statistics_CreateTables];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_User_Statistics_CreateTables]
AS
