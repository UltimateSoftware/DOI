IF OBJECT_ID('[DDI].[spRefreshMetadata_User_Tables_CreateTables]') IS NOT NULL
	DROP PROCEDURE [DDI].[spRefreshMetadata_User_Tables_CreateTables];
...
CREATE   PROCEDURE [DDI].[spRefreshMetadata_User_Tables_CreateTables]
