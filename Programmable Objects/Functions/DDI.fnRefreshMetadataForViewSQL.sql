IF OBJECT_ID('[DDI].[fnRefreshMetadataForViewSQL]') IS NOT NULL
	DROP FUNCTION [DDI].[fnRefreshMetadataForViewSQL];
...
CREATE    FUNCTION [DDI].[fnRefreshMetadataForViewSQL](
    @ViewName SYSNAME)
...
/*
    SELECT DDI.fnRefreshMetadataForViewSQL('vwPartitionFunctionPartitions')
