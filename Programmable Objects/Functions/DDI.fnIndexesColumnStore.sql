IF OBJECT_ID('[DDI].[fnIndexesColumnStore]') IS NOT NULL
	DROP FUNCTION [DDI].[fnIndexesColumnStore];
...
CREATE   FUNCTION [DDI].[fnIndexesColumnStore]()
...
/*
    select * from DDI.fnIndexesColumnStore()
*/
...
--					,ICS.OptionMaxDuration_Desired
			...
			FROM DDI.Tables TTP
				...
				INNER JOIN DDI.IndexesColumnStore ICS ON TTP.SchemaName = ICS.SchemaName
