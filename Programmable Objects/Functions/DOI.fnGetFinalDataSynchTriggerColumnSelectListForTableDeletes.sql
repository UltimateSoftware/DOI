...
IF OBJECT_ID('[DOI].[fnGetFinalDataSynchTriggerColumnSelectListForTableDeletes]') IS NOT NULL
	DROP FUNCTION [DOI].[fnGetFinalDataSynchTriggerColumnSelectListForTableDeletes];
...
SET ANSI_NULLS ON
GO
CREATE   FUNCTION [DOI].[fnGetFinalDataSynchTriggerColumnSelectListForTableDeletes](
...
/*
	select DOI.[fnGetFinalDataSynchTriggerColumnSelectListForTableDeletes]('DBO', 'Pays', 'CREATETABLE', 1, NULL, NULL)
	select DOI.[fnGetFinalDataSynchTriggerColumnSelectListForTableDeletes]('ULTIPRO_CALENDAR', 'dbo', 'EmpHJob', 1)
*/
