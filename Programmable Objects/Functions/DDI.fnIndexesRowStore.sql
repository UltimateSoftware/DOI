IF OBJECT_ID('[DDI].[fnIndexesRowStore]') IS NOT NULL
	DROP FUNCTION [DDI].[fnIndexesRowStore];
...
CREATE   FUNCTION [DDI].[fnIndexesRowStore]()   
...
/*
    SELECT * FROM DDI.fnIndexesRowStore()
*/
