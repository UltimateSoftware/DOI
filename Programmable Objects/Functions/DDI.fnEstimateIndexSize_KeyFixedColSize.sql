IF OBJECT_ID('[DDI].[fnEstimateIndexSize_KeyFixedColSize]') IS NOT NULL
	DROP FUNCTION [DDI].[fnEstimateIndexSize_KeyFixedColSize];
...
SET ANSI_NULLS ON
GO
CREATE   FUNCTION [DDI].[fnEstimateIndexSize_KeyFixedColSize]()   
...
/*
    SELECT * FROM DDI.fnEstimateIndexSize_KeyFixedColSize()   
*/
